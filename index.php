...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:saksham4200@gmail.com">saksham4200@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 8787050004</li>
					<li class="s-bar">
						<div class="search">
				   ...
				   <div class="ab-w3l-spa">
						   ...
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Come and book the Hotel now. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/me.jpg" height="120px" width="120px" alt=" " class="img-responsive" />
					</li>
					<li>
					...
					<div class="tab3">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Saksham</h4>
							<span>Owner</span>
							<p>Builded the hotel with aim to provide best luxeries facility with world class facility at a feaseable price .</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 8787050004</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:saksham4200@gmail.com">saksham4200@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> 
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2022 HOTEL SITE . All Rights Reserved | Brought To You by <a href="#">Saksham Pandey</a> </p>
		    </div>
<!--/footer -->
